      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 animate-on-scroll">
        <div className="text-center mb-20">
          ...
          <h2 className="font-sans text-3xl sm:text-4xl lg:text-5xl font-bold text-text-primary mb-4">
            Everything you need to bring<br className="hidden sm:block" /> your idea to life.
          </h2>
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="relative">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-accent-subtle text-accent mb-6 group-hover:bg-accent group-hover:text-white transition-all duration-200">
