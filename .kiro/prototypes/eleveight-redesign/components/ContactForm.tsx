    ...
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className="input-dark rounded-xl px-4 py-3 text-text-primary placeholder:text-text-muted/40"
          placeholder="Your name"
        />
        {errors.name && (
          <span id="cf-name-error" role="alert" className="text-red-400 text-xs">
            {errors.name}
          </span>
        )}
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        />
        {errors.email && (
          <span id="cf-email-error" role="alert" className="text-red-400 text-xs">
            {errors.email}
          </span>
        )}
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          ...
          className="input-dark rounded-xl px-4 py-3 text-text-primary placeholder:text-text-muted/40 resize-none"
          placeholder="Tell us about your project…"
        />
        {errors.message && (
          <span id="cf-message-error" role="alert" className="text-red-400 text-xs">
            {errors.message}
          </span>
        )}
      </div>
      ...
      <button
        type="submit"
        disabled={submitting}
        className="self-start bg-accent text-white rounded-full px-8 py-3 font-medium hover:bg-accent-hover transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
      >
