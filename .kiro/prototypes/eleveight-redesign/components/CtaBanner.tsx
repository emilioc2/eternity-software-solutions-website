  ...
  return (
    <section className="py-32">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="relative rounded-3xl overflow-hidden animate-on-scroll">
          ...
          <div
            ...
            aria-hidden="true"
            style={{
              background: 'radial-gradient(ellipse at 30% 50%, rgba(232, 86, 42, 0.08), transparent 70%)',
            }}
          />
          ...
          <div className="relative px-8 sm:px-16 py-20 text-center">
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 bg-accent text-white rounded-full px-8 py-3.5 font-medium hover:bg-accent-hover transition-colors duration-200"
            >
              Start a Project
